              ...
              <img alt="image" class="img-circle" src="img/a5.jpg" />
                ...
                <li  class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/business?method=transfer">转账</a></li>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content text-center p-md">
                            <h2><span class="text-navy">转账</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="main_right">
                <div class="rightgrid">
                    <div class="contact" >
                        <form action="${pageContext.request.contextPath}/transfer" name="form1" method="post">
                            <ul>
                                <li>
                                    <label>付款账户：</label>
