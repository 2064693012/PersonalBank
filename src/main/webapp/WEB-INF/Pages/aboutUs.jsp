              ...
              <img alt="image" class="img-circle" src="img/a5.jpg" />
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/service?method=aboutUs">关于我们</a></li>
                        </li>
                    </ul>
                </li>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content text-center p-md">
                            <h2><span class="text-navy">关于我们</span></h2>
                            <p>岭南师范学院 计算机与智能教育学院 软件工程第五小组</p>
                        </div>
                    </div>
                </div>
            </div>
