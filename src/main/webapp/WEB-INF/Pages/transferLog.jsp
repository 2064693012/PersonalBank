              ...
              <img alt="image" class="img-circle" src="img/a5.jpg" />
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/business?method=transferLog">交易明细</a></li>
                    </ul>
                </li>
                    ...
                    <table cellspacing="0" rules="all" border="1" style="border-collapse:collapse;">
                        ...
                        <c:forEach items="${list}" var="transferLog" varStatus="status">
                            <tr class="tr1">
                                ...
                                <td><a href="${pageContext.request.contextPath}/modify?method=deleteByCardId&date=${transferLog.transferTime}">删除记录</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
