...
<head>
    ...
    <link href="css/style.css?v=2.2.0" rel="stylesheet"> <link type="text/css" rel="stylesheet" href="css/transfer.css" />
              ...
              <img alt="image" class="img-circle" src="img/a5.jpg" />
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/payment?method=waterAndElectricity">水电费</a></li>
                    </ul>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content text-center p-md">
                            <h2><span class="text-navy">水电缴费</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="main_right">
                <div class="rightgrid">
                    <div class="contact" >
                        <form action="${pageContext.request.contextPath}/payment" name="form1" method="post">
                            <ul>
                                <input type="hidden" name="cardId" value="${depositor.cardid}">
                                <li>
                                    <label>缴费单位：</label>
                                    <select name="company">
                                        <option value ="广州水利集团有限公司">广州水利集团有限公司</option>
                                        <option value ="广州港华水利有限公司">广州港华水利有限公司</option>
                                        <option value="广州好水有限公司">广州好水有限公司</option>
                                        <option value="广州天然水公司">广州天然水公司</option>
                                    </select>
                                </li>
                                <li>
                                    <label>户号：</label>
