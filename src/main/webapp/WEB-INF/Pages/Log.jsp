...
<head>
    ...
    <link href="css/style.css?v=2.2.0" rel="stylesheet">  <link type="text/css" rel="stylesheet" href="css/depositor.css" />
        ...
        <div class="sidebar-collapse">
            ...
            <span>
              <img alt="image" class="img-circle" src="img/a5.jpg" />
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/log?page=1&cardID=${depositor.cardid}">查看日志</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div id="page-wrapper" class="gray-bg">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <span class="m-r-sm text-muted welcome-message"><a href="#" title="返回首页"><i class="fa fa-home"></i></a>欢迎使用江江银行</span>
                    </li>
                    <li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/login?method=success">主页</a>
                    </li>
                    <li class="active">
                        <strong>交易明细</strong>
                    </li>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content text-center p-md">
                            <h2><span class="text-navy">用户日志信息</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="text-align: center;">
                ...
                <% int totalPages = (int) Math.ceil((double) logCount / pageSize); %>

                <ul class="pagination">
                    <% if (totalPages > 1) { %>
                    <%-- Display "首页" (first page) --%>
                    <li><a href="${pageContext.request.contextPath}/log?page=1&cardID=${cardID}">首页</a></li>

                    <%-- Display "上一页" (previous page) --%>
                    <% if (currentPage > 1) { %>
                    <li><a href="${pageContext.request.contextPath}/log?page=<%= currentPage - 1 %>&cardID=${cardID}">上一页</a></li>
                    <% } else { %>
                    <li class="disabled"><a href="#">上一页</a></li>
                    <% } %>

                    <%-- Display current page --%>
                    <li class="active"><a href="#">第${currentPage}页/共<%= totalPages %>页</a></li>

                    <%-- Display "下一页" (next page) --%>
                    <% if (currentPage < totalPages) { %>
                    <li><a href="${pageContext.request.contextPath}/log?page=<%= currentPage + 1 %>&cardID=${cardID}">下一页</a></li>
                    <% } else { %>
                    <li class="disabled"><a href="#">下一页</a></li>
                    <% } %>

                    <%-- Display "尾页" (last page) --%>
                    <li><a href="${pageContext.request.contextPath}/log?page=<%= totalPages %>&cardID=${cardID}">尾页</a></li>
                    <% } %>
                </ul>
