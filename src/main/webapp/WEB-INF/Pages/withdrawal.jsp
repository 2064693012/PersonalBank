...
<head>
  ...
  <link href="css/style.css?v=2.2.0" rel="stylesheet"><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <title>取款</title>
  ...
  <script>
    // Check if the error attribute is set in the request or session
    var error = '<%= request.getAttribute("error") %>';
    // OR, if using session attribute
    // var error = '<%= session.getAttribute("error") %>';

    if (error === 'yes') {
      // Display an alert or handle the error in any way you want
      alert("取款失败，账户余额不足！");
    }
  </script>
      ...
      <ul class="nav" id="side-menu">
        ...
        <li  class="active">
          ...
          <ul class="nav nav-second-level">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/business?method=withdrawal">取款</a></li>
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
            <div class="ibox-content text-center p-md">
              <h2><span class="text-navy">取款</span></h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="main_right">
        <div class="rightgrid">
          <div class="contact" >
            <form action="${pageContext.request.contextPath}/withdrawal" name="form1" method="post">
              <ul>
                <li>
                  <label>取款账户：</label>
                ...
                <li>
                  <label>取款人名称：</label>
                  <input type="text" name="payee" placeholder="" value="${depositor. name}" readonly/>
                </li>
                <li>
                  <label>取款人账户：</label>
                  <input type="text" name="cardidOfPayee" placeholder="" value="" readonly/>
                </li>
                <li>
                  <label>附言：</label>
                  <input type="text" name="remarks" placeholder="" value="取款" readonly/>
                </li>
              </ul>
