      ...
      <ul class="nav" id="side-menu">
        ...
        <li class="active">
          ...
          <ul class="nav nav-second-level">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/business?method=currentDeposit">活期存款</a></li>
        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
            <div class="ibox-content text-center p-md">
              <h2><span class="text-navy">添加活期存款</span></h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content text-center p-md">
                <form action="${pageContext.request.contextPath}/fixedDeposit?action=addCurrentDeposit" method="post">
                  ...
                  <input type="text" id="depositType" name="depositType" placeholder="" value="活期" readonly/>
                  <br>
                  <label for="interestRate">一天利率:</label>
                  <input type="text" id="interestRate" name="interestRate" placeholder="" value="0.005" readonly/>
                  <br>
...
<script>
  ...
  // 监听开始时间、结束时间和金额输入框的变化
  startDateInput.addEventListener("input", calculateMaturityAmount);
  endDateInput.addEventListener("input", calculateMaturityAmount);
  depositAmountInput.addEventListener("input", calculateMaturityAmount);
  ...
  function calculateMaturityAmount() {
    ...
    // 计算时间差（单位为天数）
    var timeDiff = (endDate - startDate) / (1000 * 60 * 60 * 24);

    // 计算一天的利率
    var interestRate =0.005;

    // 计算本息+利息的值
    var maturityAmount = depositAmount + depositAmount * interestRate * timeDiff;
