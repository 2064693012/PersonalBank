      ...
      <ul class="nav" id="side-menu">
        ...
        <li class="active">
          ...
          <ul class="nav nav-second-level">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/fixedDeposit">活期定期记录</a></li>
          ...
          <div class="ibox float-e-margins">
            <div class="ibox-content text-center p-md">
              <div class="right_content">
                ...
                活期存款总金额: ${totalCurrentDeposit}
            定期存款总金额: ${totalFixedDeposit}
                <div>
                  <table class="table table-bordered table-striped">
                    ...
                    <jsp:useBean id="fixedDeposits" scope="request" type="java.util.List"/>
                    <c:forEach items="${fixedDeposits}" var="fixedDeposit">
                      <tr class="tr1">
                        <td>${fixedDeposit.id}</td>
                        <td>${fixedDeposit.cardID}</td>
                        <td>${fixedDeposit.startDate}</td>
                        <td>${fixedDeposit.endDate}</td>
                        <td>${fixedDeposit.depositAmount}</td>
                        <td>${fixedDeposit.depositType}</td>
                        ...
                        <td>
                          ...
                          <form action="${pageContext.request.contextPath}/fixedDeposit?action=transfer&cardID=${fixedDeposit.cardID}&id=${fixedDeposit.id}&depositAmount=${fixedDeposit.depositAmount}" method="post">
                            ...
                            <br>
                            <label for="timeDiff2">存款时间:</label>
                            <select id="timeDiff2" name="timeDiff2">
