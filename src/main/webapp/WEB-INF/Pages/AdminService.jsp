      ...
      <div class="rightgrid">
         <div class="right_apps">   
            <ul id="ctl00_cph_right_myapps">
                  ...
                  <li class="bg1"><a href="${pageContext.request.contextPath}/service?method=business">业务办理</a></li>
                  <li class="bg2"><a href="${pageContext.request.contextPath}/service?method=findAccount">快速查询余额信息</a></li>
                  <li class="bg3"><a href="${pageContext.request.contextPath}/service?method=modify">账户维护</a></li>
