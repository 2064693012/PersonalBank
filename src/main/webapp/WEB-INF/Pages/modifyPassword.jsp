              ...
              <img alt="image" class="img-circle" src="img/a5.jpg" />
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/modify?method=modifyPassword">修改密码</a></li>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content text-center p-md">
                            <h2><span class="text-navy">修改密码</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="main_right">
                <div class="rightgrid">
                    <div class="contact" >
                        <form action="${pageContext.request.contextPath}/modify" name="form1" method="post">
                            <ul>
                                <li>
                                    <label>原密码：</label>
